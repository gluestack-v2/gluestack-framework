---
title: @gluestack-v2/glue-plugin-database | gluestack-framework
...
pageTitle: @gluestack-v2/glue-plugin-database
...
```bash
  node glue add @gluestack-v2/glue-plugin-database <instance-name>
```
...
Below is the list of all the plugins the `@gluestack-v2/glue-plugin-database` relies on. This information will help you ensure that your project has all the necessary dependencies installed to use the plugin.
