---
title: @gluestack-v2/glue-plugin-develop | gluestack-framework

description: @gluestack-v2/glue-plugin-develop is the process manager for the gluestack project. This plugin helps you in managing all the installed **plugin instances** which you have created in your **Gluestack App**, and in order to do that it comes with various commands detailed in the **CLI Reference** section.

pageTitle: @gluestack-v2/glue-plugin-develop

pageDescription: @gluestack-v2/glue-plugin-develop is the process manager for the gluestack project. This plugin helps you in managing all the installed **plugin instances** which you have created in your **Gluestack App**, and in order to do that it comes with various commands detailed in the **CLI Reference** section.
...
<Meta title="Plugins/Development Plugins/@gluestack-v2/glue-plugin-develop" />
...
Below is the list of all the plugins the `@gluestack-v2/glue-plugin-develop` relies on. This information will help you ensure that your project has all the necessary dependencies installed to use the plugin.
